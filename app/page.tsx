...
<div className="reveal-element mb-16">
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-4 h-4">
        ...
        >
         ...
         {!showInvestContact ? (
  <button
    onClick={() => setShowInvestContact(true)}
  ...
  <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-2">
    <a
      ...
      className="w-full sm:w-auto text-center flex items-center justify-center gap-2 border border-cream/20 text-cream/70 font-dm-sans text-sm tracking-[0.15em] uppercase px-10 py-4 rounded-full hover:border-gold hover:text-gold transition-all duration-300"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
